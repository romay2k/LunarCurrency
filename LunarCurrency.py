...
URL_SCRIPT = "https://raw.githubusercontent.com/romay2k/LunarCurrency/main/LunarCurrency.py"
URL_VERSION = "https://raw.githubusercontent.com/romay2k/LunarCurrency/main/version.txt"
...
def check_for_updates(local_version_file="version.txt"):
    try:
        ...
        if online_version != local_version:
            ...
            return online_version  # Retorna a nova versão para atualização
        else:
...
def main():
    ...
    if new_version:
        ...
        # Executa a função principal se não estiver chamando diretamente
        import LunarCurrency  # Importa o script principal
...
# Labels
texto = Label(window, text="Clique no botão para ver a cotação das moedasCUUUUU")
